...
/**
 * Transaction module tests aligned with the existing framework.
 * Covers TC_419 through TC_441.
 */
public class TransactionsTests extends BaseTest {
	...
	private void loginAsRegisteredUser() {
		try {
			login.openLogin();
			login.enterEmail(getConsumerEmail());
			login.enterPassword(getConsumerPassword());
			login.clickLogin();
			Thread.sleep(2000);
	...
	private void navigateToTransactionsPage() {
		try {
			...
			throw new RuntimeException("Failed to navigate to Transactions page", e);
		}
	}
	...
	public void verifyTransactionsDisplayedInCardFormat() {
		...
		// Validation 4: Each transaction card should have required details (plan, date, amount, status)
	...
	public void verifyTransactionCardShowsPlanDateAmount() {
		skipIfValidCredentialsMissing();
		loginAsRegisteredUser();
		navigateToTransactionsPage();
		...
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
			"TC_420: Transactions page should be displayed");
		...
		// Validation 5: Amount should be visible, not empty, and contain currency symbol or numeric value
		String amount = transactions.getFirstTransactionAmount();
		...
		LOGGER.info("TC_420: Plan name, date, amount visible - Plan: " + plan + ", Date: " + date + ", Amount: " + amount);
	}
	...
	public void verifyTransactionStatusCompletedDisplayed() {
		skipIfValidCredentialsMissing();
		loginAsRegisteredUser();
		navigateToTransactionsPage();
		...
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
			"TC_421: Transactions page should be displayed");
		...
		// Validation 4: Status should be one of the expected values (Completed, Cancelled, Refunded, Pending)
		String[] expectedStatuses = {"Completed", "Cancelled", "Refunded", "Pending", "Processing"};
		boolean statusMatch = false;
		for (String expectedStatus : expectedStatuses) {
			if (status.equalsIgnoreCase(expectedStatus) || status.toLowerCase().contains(expectedStatus.toLowerCase())) {
				statusMatch = true;
				break;
			}
		}
		Assert.assertTrue(statusMatch, "TC_421: Status should be one of: Completed, Cancelled, Refunded, Pending, Processing. Found: " + status);
	...
	public void verifyTransactionAmountDisplayed() {
		skipIfValidCredentialsMissing();
		loginAsRegisteredUser();
		navigateToTransactionsPage();
		...
		// Validation 1: Transactions page should be displayed
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
			"TC_422: Transactions page should be displayed");
		...
		// Validation 4: Amount should contain currency symbol (₹ or Rs) or numeric digits
	...
	public void verifyTransactionDateTimeFormat() {
		skipIfValidCredentialsMissing();
		loginAsRegisteredUser();
		navigateToTransactionsPage();
		...
		// Validation 1: Transactions page should be displayed
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
			"TC_423: Transactions page should be displayed");
		...
		// Validation 3: Date/time should be displayed
		String dateTime = transactions.getFirstTransactionDate();
		Assert.assertNotNull(dateTime, "TC_423: Transaction date/time should be displayed");
		Assert.assertFalse(dateTime.trim().isEmpty(), "TC_423: Transaction date/time should not be empty");

		// Validation 4: Date should be in YYYY-MM-DD format or contain date pattern
		Assert.assertTrue(dateTime.matches(".*\\d{4}-\\d{2}-\\d{2}.*") || dateTime.matches(".*\\d{2}/\\d{2}/\\d{4}.*"),
			"TC_423: Date should be in YYYY-MM-DD or DD/MM/YYYY format. Found: " + dateTime);

		// Validation 5: Should contain time information
		Assert.assertTrue(dateTime.matches(".*\\d{1,2}:\\d{2}.*") || dateTime.matches(".*AM|PM.*"),
			"TC_423: DateTime should contain time (HH:MM or AM/PM). Found: " + dateTime);

		LOGGER.info("TC_423: Correct format displayed - Format: " + dateTime);
	}
	...
	public void verifyPaymentMethodDisplayed() {
		...
		// Validation 1: Transactions page should be displayed
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
			"TC_424: Transactions page should be displayed");
		...
		Assert.assertTrue(paymentMethodLower.contains("card") || paymentMethodLower.contains("upi") || paymentMethodLower.contains("payment"),
	...
	public void verifySubscriptionDurationDisplayed() {
		skipIfValidCredentialsMissing();
		loginAsRegisteredUser();
		navigateToTransactionsPage();
		...
		// Validation 1: Transactions page should be displayed
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
			"TC_425: Transactions page should be displayed");
		...
		// Validation 4: Duration should mention months or days (e.g., "1 month", "30 days")
		...
		Assert.assertTrue(duration.matches(".*\\d+.*"), "TC_425: Duration should contain numeric value. Found: " + duration);
	...
	public void verifyInvoiceDownload() {
		...
		// Validation 1: Transactions page should be displayed
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
			"TC_426: Transactions page should be displayed");
	...
	public void verifySearchByValidTransactionId() {
		skipIfValidCredentialsMissing();
		loginAsRegisteredUser();
		navigateToTransactionsPage();
		...
		// Validation 1: Transactions page should be displayed
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
			"TC_427: Transactions page should be displayed");

		// Validation 2: Search input should be accessible
		String validTxnId = "TXN1001";
		try {
			...
			// Validation 4: Either matching transaction found or "No data found" message should appear
	...
	public void verifySearchInvalidIdShowsNoResult() {
		skipIfValidCredentialsMissing();
		loginAsRegisteredUser();
		navigateToTransactionsPage();
		...
		// Validation 1: Transactions page should be displayed
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
			"TC_428: Transactions page should be displayed");
		...
		boolean noDataMessage = transactions.isNoDataFoundMessageDisplayed();
		Assert.assertTrue(noDataMessage, "TC_428: 'No data found' or 'No results' message should be displayed for invalid search");
		...
		LOGGER.info("TC_428: \"No data found\" displayed - Message found: " + noDataMessage + ", Result count: " + resultCount);
	}
	...
	public void verifyEmptySearchShowsDefaultList() {
		skipIfValidCredentialsMissing();
		loginAsRegisteredUser();
		navigateToTransactionsPage();
		...
		// Validation 1: Transactions page should be displayed
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
			"TC_429: Transactions page should be displayed");
		...
		// Validation 5: Count should be same as or greater than initial (all transactions shown)
		Assert.assertTrue(afterClearCount >= initialCount,
			"TC_429: Clearing search should show all transactions. Initial: " + initialCount + ", After clear: " + afterClearCount);

		LOGGER.info("TC_429: Default list displayed - Initial count: " + initialCount + ", After clear: " + afterClearCount);
	}
	...
	public void verifyFilterPopupOpens() {
		skipIfValidCredentialsMissing();
		loginAsRegisteredUser();
		navigateToTransactionsPage();
		...
		// Validation 1: Transactions page should be displayed
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
			"TC_430: Transactions page should be displayed");
	...
	public void verifyFilterByStatusCompleted() {
		skipIfValidCredentialsMissing();
		loginAsRegisteredUser();
		navigateToTransactionsPage();
		...
		// Validation 1: Transactions page should be displayed
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
			"TC_431: Transactions page should be displayed");
		...
		transactions.clickFilterButton();
		Assert.assertTrue(transactions.isFilterPopupDisplayed(),
			"TC_431: Filter popup should be displayed");
		...
		// Validation 5: Verify filter applied - check if any transactions are displayed
		int filteredCount = transactions.getTransactionCount();
		LOGGER.info("TC_431: Filtered transaction count (Completed): " + filteredCount);

		LOGGER.info("TC_431: Completed status filter applied successfully");
	}
	...
	public void verifyFilterByStatusCancelled() {
		skipIfValidCredentialsMissing();
		loginAsRegisteredUser();
		navigateToTransactionsPage();
		...
		// Validation 1: Transactions page should be displayed
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
			"TC_432: Transactions page should be displayed");
		...
		transactions.clickFilterButton();
		Assert.assertTrue(transactions.isFilterPopupDisplayed(),
			"TC_432: Filter popup should be displayed");
		...
		LOGGER.info("TC_432: Cancelled status filter applied successfully");
	}
	...
	public void verifyFilterByStatusRefunded() {
		skipIfValidCredentialsMissing();
		loginAsRegisteredUser();
		navigateToTransactionsPage();
		...
		// Validation 1: Transactions page should be displayed
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
			"TC_433: Transactions page should be displayed");
		...
		transactions.clickFilterButton();
		Assert.assertTrue(transactions.isFilterPopupDisplayed(),
			"TC_433: Filter popup should be displayed");
		...
		LOGGER.info("TC_433: Refunded status filter applied successfully");
	}
	...
	public void verifyFilterByDate() {
		...
		// Validation 1: Transactions page should be displayed
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
			"TC_434: Transactions page should be displayed");
		...
		transactions.clickFilterButton();
		Assert.assertTrue(transactions.isFilterPopupDisplayed(),
			"TC_434: Filter popup should be displayed");
	...
	public void verifyFilterByPaymentMethod() {
		skipIfValidCredentialsMissing();
		loginAsRegisteredUser();
		navigateToTransactionsPage();
		...
		// Validation 1: Transactions page should be displayed
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
			"TC_435: Transactions page should be displayed");
		...
		transactions.clickFilterButton();
		Assert.assertTrue(transactions.isFilterPopupDisplayed(),
			"TC_435: Filter popup should be displayed");
	...
	public void verifyApplyFilterButton() {
		...
		// Validation 1: Transactions page should be displayed
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
			"TC_436: Transactions page should be displayed");
		...
		transactions.clickFilterButton();
		Assert.assertTrue(transactions.isFilterPopupDisplayed(),
			"TC_436: Filter popup should be displayed");
		...
		// Validation 5: Verify filter was applied - page still displayed and count may have changed
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
	...
	public void verifyMultipleFilters() {
		...
		// Validation 1: Transactions page should be displayed
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
			"TC_437: Transactions page should be displayed");
		...
		transactions.clickFilterButton();
		Assert.assertTrue(transactions.isFilterPopupDisplayed(),
			"TC_437: Filter popup should be displayed");
	...
	public void verifyNoResultAfterFilter() {
		skipIfValidCredentialsMissing();
		loginAsRegisteredUser();
		navigateToTransactionsPage();
		...
		// Validation 1: Transactions page should be displayed
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
			"TC_438: Transactions page should be displayed");
		...
		// Validation 4: Transaction count should be zero or very low (no matching results)
		int resultCount = transactions.getTransactionCount();
	...
	public void verifySpecialCharacterSearch() {
		...
		// Validation 1: Transactions page should be displayed
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
			"TC_439: Transactions page should be displayed");
		...
		// Validation 4: No error or exception should occur (implicitly verified by reaching this point)
	...
	public void verifyMaxLengthTransactionId() {
		skipIfValidCredentialsMissing();
		loginAsRegisteredUser();
		navigateToTransactionsPage();
		...
		// Validation 1: Transactions page should be displayed
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
			"TC_440: Transactions page should be displayed");
	...
	public void verifyInvoiceDownloadErrorHandling() {
		skipIfValidCredentialsMissing();
		loginAsRegisteredUser();
		navigateToTransactionsPage();
		...
		// Validation 1: Transactions page should be displayed
		Assert.assertTrue(transactions.isTransactionsPageDisplayed(),
			"TC_441: Transactions page should be displayed");
